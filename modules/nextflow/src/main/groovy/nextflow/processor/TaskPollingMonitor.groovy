...
class TaskPollingMonitor implements TaskMonitor {
    ...
    private Map<String, String> createTaskLabel(GroovyRowResult sqlRow) {
        ...
        Double run_rchar_25 = sqlRow.getProperty("rchar_25") as Double
        Double run_rchar_75 = sqlRow.getProperty("rchar_75") as Double
        ...
        Double run_wchar_25 = sqlRow.getProperty("wchar_25") as Double
        Double run_wchar_75 = sqlRow.getProperty("Wchar_75") as Double
